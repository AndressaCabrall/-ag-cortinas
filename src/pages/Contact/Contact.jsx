...
function Contact() {
  ...
  const [contatoStatus, setContatoStatus] = useState(null) // null | 'loading' | 'success' | 'error'
    ...
    <main className="contact" aria-label="Página de Contato — AG Cortinas e Persianas">
      ...
      <div className="contact-form-wrapper">
        ...
        {activeTab === 'mensagem' && (
          ...
          >
            ...
            <button
              ...
              disabled={contatoStatus === 'loading'}
            >
        ...
        {activeTab === 'agendamento' && (
          <form
            className="contact-form"
            aria-label="Formulário de agendamento de visita"
          ...
          >
            ...
            <div className="contact-field">
              ...
              <input
                type="text" id="a-nome" name="nome"
                placeholder="Seu nome"
                value={agendaForm.nome}
            ...
            <div className="contact-row">
              <div className="contact-field">
                ...
                <input
                  type="email" id="a-email" name="email"
                  placeholder="seu@email.com"
              ...
              <div className="contact-field">
                ...
                <input
                  type="tel" id="a-telefone" name="telefone"
                  placeholder="(47) 00000-0000"
            ...
            <div className="contact-field">
              ...
              <select
                id="a-servico" name="servico"
                value={agendaForm.servico}
                onChange={handleAgendaChange}
              >
                <option value="">Selecione...</option>
                <option value="cortinas">Cortinas</option>
            ...
            <div className="contact-field">
              ...
              <input
                type="text" id="a-endereco" name="endereco"
            ...
            <div className="contact-field">
              ...
              <input
                type="text" id="a-complemento" name="complemento"
                placeholder="Apto, bloco, referência..."
                value={agendaForm.complemento}
                onChange={handleAgendaChange}
              />
            </div>
            ...
            <div className="contact-field">
              ...
              <textarea
                id="a-observacoes" name="observacoes"
                placeholder="Quantos ambientes, alguma preferência de produto..."
                rows="3"
            ...
            {agendaStatus === 'success' && (
              <p className="contact-feedback success">
                ✓ Agendamento solicitado! Entraremos em contato para confirmar.
              </p>
            )}
            {agendaStatus === 'error' && (
              <p className="contact-feedback error">
                ✗ Erro ao agendar. Tente novamente ou nos chame no WhatsApp.
              </p>
            )}
