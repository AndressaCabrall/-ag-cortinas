...
function About() {
  ...
  useSEO({
    ...
    description: 'Conheça a AG Cortinas e Persianas. Mais de 13 anos transformando ambientes com elegância, qualidade e atendimento personalizado em Joinville e região.',
    url: '/about',
  })
    ...
    <main className="about" aria-label="Sobre a AG Cortinas e Persianas">
      ...
      <div className="about-content">
        ...
        <div className="about-texto-wrapper">
          ...
          <h2 className="about-texto-titulo">Com mais de 13 anos transformando lares</h2>
      ...
      <div className="about-diferenciais">
        <div className="about-diferenciais-header">
          ...
          <h2 className="about-diferenciais-titulo">Nosso compromisso com você</h2>
        </div>
      ...
      <div className="about-cta">
        <h2 className="about-cta-titulo">Pronta para transformar seu ambiente?</h2>
        ...
        <Link to="/contact" className="about-cta-btn">Agendar consultoria</Link>
      </div>
